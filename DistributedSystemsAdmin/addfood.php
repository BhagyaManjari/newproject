...
if (isset($_POST['submit'])) {
    ...
    $url = "http://localhost/DistributedSystemsMiddleware/addproduct.php";

    $param = "name=".$name."&type=".$type."&price=".$price."&description=".$description;

    $result = createPostRequest($url, $param);
}
...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="./managefood.php">
                        <i class="ni ni-tv-2 text-primary"></i> Manage Food
                    </a>
                </li>
                <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-first-name">Item Name</label>
                                            <input type="text" id="input-first-name" name="name" class="form-control form-control-alternative" placeholder="Name" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-last-name">Type</label>
                                            <input type="text" id="input-last-name" name="type" class="form-control form-control-alternative" placeholder="Type" value=""  required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-first-name" name="price" class="form-control form-control-alternative" placeholder="Price" value=""  required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-last-name">Description</label>
                                            <input type="text" id="input-last-name" name="description" class="form-control form-control-alternative" placeholder="Description" value=""  required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 text-right">
                                <input type="submit" name="submit" value="Add food" class="btn btn-sm btn-primary">
                            </div>
                        </form>
                    </div>
                </div>
